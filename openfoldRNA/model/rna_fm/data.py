...
from model.rna_fm.constants import proteinseq_toks, rnaseq_toks
...
def get_rna_fm_token(fas_path,
    ...
    fea1d = batch_tokens.data.cpu().numpy()[0, 1:-1]

    return torch.LongTensor(fea1d)
